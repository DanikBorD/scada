...
{
    public partial class termometr_4 : Form
    {
        ...
        private void ReadDM()
        {
            ...
            try
            {
                ...
                temperatureValue_4.Text = dmval.ToString();

                messegeList_4.Text = cnt.plc.LastDialog("READ DM");
                messegeList_4.AppendText("DM VALUE: " + dmval.ToString());
        ...
        {
            temperatureValue_4.Text = temperature.ToString();
        }
        ...
        public void DangerLabel(int temperature)
        {
            ...
            {
                levelOfNormalize_4.Text = "BED";
                levelOfNormalize_4.BackColor = Color.Red;
            }
            else
            {
                levelOfNormalize_4.Text = "OK";
                levelOfNormalize_4.BackColor = Color.LawnGreen;
            }
        }

        public void Difference(int temperature)
        {
            differenceValue_4.Text = (temperature - normalTemperature).ToString();
        }

        public void NormalTemperature(int temperature)
        {
            normal_4.Text = normalTemperature.ToString();
        }

        private void getValueButton_4_Click(object sender, EventArgs e)
        {
